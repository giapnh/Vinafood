...
import hust.hgbk.vtio.vinafood.ontology.simple.*;
...
public class OntologyCache {
	//	public static ArrayList<InstanceDataSimple> listAllSimpleClass = new ArrayList<InstanceDataSimple>();
	//	public static ArrayList<InstanceDataSimple> listSubject = new ArrayList<InstanceDataSimple>();
	//	public static ArrayList<InstanceDataSimple> listPredicate = new ArrayList<InstanceDataSimple>();
	//	public static ArrayList<InstanceDataSimple> listObject = new ArrayList<InstanceDataSimple>();
	...
	//	public static HashMap<String, LabelIconSimple> hashMapLabelIcon = new HashMap<String, LabelIconSimple>();
	...
	//	public static ArrayList<ArrayList<ClassDataSimple>> allSubClassLevel2OfTopic=new ArrayList<ArrayList<ClassDataSimple>>();
	 ...
	 * uriOfIcon.put("http://hust.se.vtio.owl#Dining-Service",diningServiceIcon);
	 * 
	 ...
	 * uriOfIcon.put("http://hust.se.vtio.owl#Health-Service",healthServiceIcon);
	 * 
	 ...
	 * uriOfIcon.put("http://hust.se.vtio.owl#Sidewalk-Food",side_walk_foodIcon);
	 * 
	 ...
	 * uriOfIcon.put("http://hust.se.vtio.owl#Tourist-Resource",tourist_resourceIcon
	 * );
	 * 
	 ...
	 * uriOfIcon.put("http://hust.se.vtio.owl#Filling-Station",filling_stationIcon
	 * );
	 * 
	 * }
	 */
	...
	public static void clearCache() {
		...
		/*
		 * if (hashMapLabelIcon != null) {
		 * hashMapLabelIcon.clear();
		 * }
