...
//    	   Log.v("TEST", navigationDataSet.getCurrentPlacemark().getDescription());
...
//	 Log.v("MAP", "s: " + new String(ch,0,ch.length));
    if(this.in_nametag){ 
    ...
    if(this.in_descriptiontag){ 
        ...
        try {
        	temp2 =temp1[0].split("&");
        	temp = temp2[0]+temp1[1];
        } catch (Exception e) {
			// TODO: handle exception
		}
        navigationDataSet.getCurrentPlacemark().setDescription(temp);
    } else
