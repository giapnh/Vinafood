...
public class NewDinningServiceSearch extends Activity {
	...
	public void init() {
		...
		edtSearch.postDelayed(new Runnable() {
			@Override
			public void run() {
				InputMethodManager mInputMethodManager = (InputMethodManager) NewDinningServiceSearch.this
	...
	public void onCityFilter(View v) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				((TextView) NewDinningServiceSearch.this
	...
	public void onBusineseFilter(View v) {
		filterDialog = new Dialog(NewDinningServiceSearch.this,
