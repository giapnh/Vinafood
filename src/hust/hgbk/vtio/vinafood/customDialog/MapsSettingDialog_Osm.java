...
public class MapsSettingDialog_Osm extends Dialog implements android.view.View.OnClickListener{
	Context context;
	Button btnCancel;
	Button btnOk;
	...
	public MapsSettingDialog_Osm(Context context, MapView mapView) {
		super(context);
